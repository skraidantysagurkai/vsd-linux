...
class PredictionAPI:
    ...
    def get_features_history(self, log: dict) -> dict:
        try:    
            ...
            thirty_sec_avg_embeds = self.ml_pipeline.transform_features(average_features_30).get()[0][[1, 5, 7]]
            # we only need number 5 and 6
            five_min_avg_embeds = self.ml_pipeline.transform_features(average_features_300).get()[0][4]
